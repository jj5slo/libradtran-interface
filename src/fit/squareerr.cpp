...
double fit::root_mean_square_log_error(int Ndata, double* heights, double* obs, double* sim){
	double sqle = fit::square_log_error(Ndata, obs, sim);
	return std::sqrt( sqle / Ndata );
}
double fit::root_mean_square_log_error(int min_index, int max_index, double* obs, double* sim){
...
double fit::root_mean_square_log_error(int Ndata, double min_height, double max_height, double* heights, double* obs, double* sim){
	int Ntarget = 0;
