...
double func(const std::vector<double>& x, std::vector<double>& g, void* args){
	return (x[0]-3.14159265358979)*(x[0]-3.14159265358979) + 2.718281828 ;
}
...
int main(int argc, char* argv[]){
	...
	double x;
	void* args;
	double minf = golden_section_search(x, 0.0, 4.0, std::stod(argv[1]), func, args);
	std::cout << minf <<" at "<< x <<std::endl;
}
